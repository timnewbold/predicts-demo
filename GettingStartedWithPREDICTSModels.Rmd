...
Variation in species richness that is explained by the fixed effect (land use) is very low. Residuals are not very close to a normal distribution and show evidence of heteroskedascity. But we haven't included many potentially important explanatory variables at this stage.
